        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="group stagger-item">
            <div className="relative overflow-hidden rounded-3xl shadow-luxury-hover hover:shadow-luxury transition-all duration-500 hover:-translate-y-2">
              {/* Decorative border */}
              <div className="absolute inset-0 border-4 border-amber-400/0 group-hover:border-amber-400/30 rounded-3xl transition-all duration-500 z-10"></div>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-slate-900 via-slate-900/95 to-transparent p-8">
                <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  <div className="w-16 h-1 bg-gradient-to-r from-amber-400 to-yellow-500 rounded-full mb-4"></div>
                  <h3 className="text-3xl font-bold text-white mb-2">Nawal [Last Name]</h3>
                  <p className="text-amber-300 text-sm uppercase tracking-wider font-semibold">{t.partners.partner1}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl shadow-luxury-hover hover:shadow-luxury transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="aspect-[3/4] bg-gradient-to-br from-slate-800 via-slate-700 to-slate-900 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-6 p-10">
                  <div className="w-40 h-40 mx-auto bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border-4 border-white/20 group-hover:border-amber-400/50 transition-colors duration-500 shadow-2xl">
                    <div className="w-24 h-24 bg-gradient-to-br from-amber-400/20 to-yellow-500/20 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
                  </div>
                  <div className="space-y-3">
                    <div className="w-20 h-1 bg-gradient-to-r from-amber-400 to-yellow-500 rounded-full mx-auto"></div>
                    <h3 className="text-3xl font-bold text-white">[Name]</h3>
                    <p className="text-amber-300 text-sm uppercase tracking-wider font-semibold">{t.partners.partner2}</p>
                  </div>
                </div>
              </div>
            </div>
